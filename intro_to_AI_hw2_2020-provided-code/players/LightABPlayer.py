...
import numpy as np
from SearchAlgos import State, AlphaBeta, score_heuristic, successor_states, phases_sum_heuristic
...
class Player(AbstractPlayer):
    ...
    def make_move(self, time_limit, players_score):
        ...
        h_val, chosen_direction, _ = self.algorithm.search(current_state, depth, 1,
                                                            300000, self.penalty_score)
